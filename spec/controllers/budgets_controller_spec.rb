  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved budget as @budget" do
        ...
        post :create, {:budget => { "name" => "invalid value" }}, valid_session
        assigns(:budget).should be_a_new(Budget)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested budget" do
        ...
        Budget.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => budget.to_param, :budget => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the budget as @budget" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Budget.any_instance.stub(:save).and_return(false)
        put :update, {:id => budget.to_param, :budget => { "name" => "invalid value" }}, valid_session
        assigns(:budget).should eq(budget)
      end
